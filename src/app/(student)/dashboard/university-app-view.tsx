  ...
  return (
    <div className="space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            {meta.admissionsPhone && (
              <span className="flex items-center gap-1.5">
                <span className="text-[#888]">{t("uniApp.phone")}</span>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          <h2 className="mb-2 text-lg font-bold text-[#1a1a1a]">{t("uniApp.deadlines")}</h2>
          <p className="text-sm text-[#888]">{t("uniApp.deadlinesTBA")}</p>
        </div>

        <div>
          <h2 className="mb-2 text-lg font-bold text-[#1a1a1a]">{t("uniApp.links")}</h2>
            ...
            {university.website ? (
              <li>
                <a href={university.website} target="_blank" rel="noopener noreferrer" className={linkCls}>
                  {t("uniApp.websiteLink")} <ExternalLink size={12} />
                </a>
              </li>
            ) : (
              <li className="text-[#999]">{t("uniApp.websiteNotProvided")}</li>
            )}
            {meta.aboutUrl && (
              <li>
                <a href={meta.aboutUrl} target="_blank" rel="noopener noreferrer" className={linkCls}>
                  {t("uniApp.aboutLink")} <ExternalLink size={12} />
                </a>
              </li>
            )}
            {meta.admissionsUrl ? (
              <li>
                <a href={meta.admissionsUrl} target="_blank" rel="noopener noreferrer" className={linkCls}>
                  {t("uniApp.admissionsLink")} <ExternalLink size={12} />
                </a>
              </li>
            ) : (
              <li className="text-[#999]">{t("uniApp.admissionsNotProvided")}</li>
            )}
            {meta.campusMapUrl && (
              <li>
                <a href={meta.campusMapUrl} target="_blank" rel="noopener noreferrer" className={linkCls}>
                  {t("uniApp.campusMapLink")} <ExternalLink size={12} />
                </a>
              </li>
            )}
            {meta.financialAidUrl ? (
              <li>
                <a href={meta.financialAidUrl} target="_blank" rel="noopener noreferrer" className={linkCls}>
                  {t("uniApp.financialAidLink")} <ExternalLink size={12} />
                </a>
              </li>
            ) : (
              <li className="text-[#999]">{t("uniApp.financialAidNotProvided")}</li>
            )}
          </ul>
          <div className="mt-3 flex flex-wrap items-center gap-2.5">
            {meta.facebookUrl ? (
              <a href={meta.facebookUrl} target="_blank" rel="noopener noreferrer" className={socialLinkCls} aria-label="Facebook"><Facebook size={16} /></a>
            ) : (
              <span className={socialDisabledCls} aria-label="Facebook"><Facebook size={16} /></span>
            )}
            {meta.instagramUrl ? (
              <a href={meta.instagramUrl} target="_blank" rel="noopener noreferrer" className={socialLinkCls} aria-label="Instagram"><Instagram size={16} /></a>
            ) : (
              <span className={socialDisabledCls} aria-label="Instagram"><Instagram size={16} /></span>
            )}
            {meta.twitterUrl ? (
              <a href={meta.twitterUrl} target="_blank" rel="noopener noreferrer" className={socialLinkCls} aria-label="Twitter"><Twitter size={16} /></a>
            ) : (
              <span className={socialDisabledCls} aria-label="Twitter"><Twitter size={16} /></span>
            )}
            {meta.youtubeUrl ? (
              <a href={meta.youtubeUrl} target="_blank" rel="noopener noreferrer" className={socialLinkCls} aria-label="YouTube"><Youtube size={16} /></a>
            ) : (
              <span className={socialDisabledCls} aria-label="YouTube"><Youtube size={16} /></span>
            )}
          </div>
        </div>
      </div>
      ...
      <CollapsibleSection
        title={t("uniApp.appInfo")}
        open={appInfoOpen}
        onToggle={() => setAppInfoOpen(!appInfoOpen)}
      >
        <div className="space-y-4 pt-3">
          <InfoBlock title={t("uniApp.appFees")}>
            <ul className="ml-5 list-disc space-y-1 text-sm text-[#444] marker:text-[#ccc]">
              <li>{t("uniApp.feeIntlFirstYear")}</li>
              <li>{t("uniApp.feeDomesticFirstYear")}</li>
            </ul>
          </InfoBlock>
          <InfoBlock title={t("uniApp.testPolicy")} help>
            <ul className="ml-5 list-disc space-y-1 text-sm text-[#444] marker:text-[#ccc]">
              <li>{t("uniApp.flexible")}</li>
              <li>{t("uniApp.seeWebsite")}</li>
            </ul>
          </InfoBlock>
          <InfoBlock title={t("uniApp.englishTests")}>
            <p className="text-sm text-[#444]">{t("uniApp.seeWebsite")}</p>
          </InfoBlock>
          <InfoBlock title={t("uniApp.coursesGrades")}>
            <p className="text-sm text-[#444]">{t("uniApp.notUsed")}</p>
          </InfoBlock>
          <InfoBlock title={t("uniApp.recommendations")}>
            <ul className="ml-5 list-disc space-y-1 text-sm text-[#444] marker:text-[#ccc]">
              <li>{t("uniApp.schoolReport")}</li>
              <li>{t("uniApp.counselorRec")}</li>
              <li>{t("uniApp.finalReport")}</li>
            </ul>
          </InfoBlock>
          <InfoBlock title={t("uniApp.additionalInfo")}>
            <p className="text-sm leading-relaxed text-[#444]">
              {tReplace("uniApp.admissionsPolicy", locale, { name: title })}
            </p>
          </InfoBlock>
        </div>
      </CollapsibleSection>
      ...
      <CollapsibleSection
        title={t("uniApp.writing")}
        open={writingOpen}
        onToggle={() => setWritingOpen(!writingOpen)}
      >
        <div className="space-y-4 pt-3">
          <InfoBlock title={t("uniApp.commonAppEssay")}>
            <p className="text-sm text-[#444]">{t("uniApp.notProvided")}</p>
          </InfoBlock>
          <InfoBlock title={t("uniApp.collegeQuestions")}>
            <p className="text-sm text-[#444]">{t("uniApp.notProvided")}</p>
          </InfoBlock>
          <InfoBlock title={t("uniApp.writingSupplement")}>
            <p className="text-sm text-[#444]">{t("uniApp.writingSupplementDesc")}</p>
          </InfoBlock>
        </div>
      </CollapsibleSection>

      <CollapsibleSection
        title={t("uniApp.specificInfo")}
        open={specificOpen}
        onToggle={() => setSpecificOpen(!specificOpen)}
      >
        <p className="pt-3 text-sm leading-relaxed text-[#444]">
          {t("uniApp.specificInfoDesc")}
        </p>
      </CollapsibleSection>
      ...
      <div className="flex items-center justify-between gap-4 border-t border-[#e8e8e8] pt-3">
        <div>
          <h3 className="text-sm font-semibold text-[#1a1a1a]">{t("uniApp.removeTitle")}</h3>
          <p className="mt-0.5 text-xs text-[#888]">{t("uniApp.removeDesc")}</p>
        </div>
        <button
          onClick={onRemove}
...
function GeneralPage({ draft, onChange }: {
  locale: "en" | "th";
  draft: UniDraft;
  onChange: (d: UniDraft) => void;
}) {
  const { t } = useLocale();
  const rounds = ["1", "2", "4"] as const;
  const plans = ["regular", "international", "quota"] as const;
  const planLabel = (p: string) =>
    p === "regular" ? t("uniApp.planRegular") : p === "international" ? t("uniApp.planInternational") : t("uniApp.planQuota");
  const roundLabel = (r: string) =>
    r === "1" ? t("uniApp.round1") : r === "2" ? t("uniApp.round2") : t("uniApp.round4");

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-[#1a1a1a]">{t("uniApp.general")}</h1>

      <div className="rounded-xl border border-[#e8e8e8] bg-white p-6 space-y-6">
        <div>
          <label className="mb-2 block text-sm font-medium text-[#1a1a1a]">
            {t("uniApp.preferredRound")} <span className="text-red-500">*</span>
          </label>
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-[#1a1a1a]">
            {t("uniApp.preferredPlan")} <span className="text-red-500">*</span>
          </label>
          <div className="flex flex-wrap gap-2">
            {plans.map((p) => (
              <PillButton
...
function AcademicsPage({ university, locale, draft, onChange }: {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-[#1a1a1a]">{t("uniApp.academics")}</h1>
      ...
      {faculties.length === 0 ? (
        ...
        <div className="space-y-4 rounded-xl border border-[#e8e8e8] bg-white p-6">
          <div>
            <label className="mb-2 block text-sm font-medium text-[#1a1a1a]">
              {t("uniApp.selectFaculty")} <span className="text-red-500">*</span>
            </label>
            <select
            ...
            >
              <option value="">{t("uniApp.selectOption")}</option>
              {faculties.map((f) => (
          ...
          {selectedFaculty && (
            <div>
              <label className="mb-2 block text-sm font-medium text-[#1a1a1a]">
                {t("uniApp.selectProgram")} <span className="text-red-500">*</span>
              </label>
              {programs.length === 0 ? (
                <p className="text-sm text-[#888]">{t("uniApp.noPrograms")}</p>
              ) : (
                <select
...
function OtherPage({ draft, onChange }: {
  locale: "en" | "th";
  draft: UniDraft;
  onChange: (d: UniDraft) => void;
}) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-[#1a1a1a]">{t("uniApp.other")}</h1>

      <div className="rounded-xl border border-[#e8e8e8] bg-white p-6 space-y-3">
        <label className="block text-sm font-medium text-[#1a1a1a]">
          {t("uniApp.essayPrompt")} <span className="text-red-500">*</span>
        </label>
        <textarea
          value={draft.essay ?? ""}
          onChange={(e) => onChange({ ...draft, essay: e.target.value })}
          rows={10}
          placeholder={t("uniApp.essayPlaceholder")}
          className="w-full rounded-lg border border-[#e0e0e0] px-4 py-3 text-sm outline-none focus:border-[#F4C430] focus:ring-2 focus:ring-[#F4C430]/20"
        />
        <p className="text-xs text-[#999]">
          {(draft.essay ?? "").length} {t("uniApp.characters")}
        </p>
      </div>
    </div>
  );
...
function ReviewAndSubmitPage({
  ...
  if (sectionStatus.general !== "completed") {
    incompleteUni.push({ key: "general", label: t("uniApp.generalSpecific") });
  }
  if (sectionStatus.academics !== "completed") {
    incompleteUni.push({ key: "academics", label: t("uniApp.academics") });
  }
  if (sectionStatus.other !== "completed") {
    incompleteUni.push({ key: "other", label: t("uniApp.other") });
  }
      ...
      {!allComplete && (
        <div className="rounded-xl border border-[#e8e8e8] bg-white p-8">
          <p className="mb-5 text-[15px] leading-relaxed text-[#444]">
            {t("uniApp.submissionIntroIncompleteAlt")}
          </p>
      ...
      {allComplete && (
        <div className="space-y-6">
          <p className="text-[15px] leading-relaxed text-[#444]">
            {tReplace("uniApp.readyIntro", locale, { name: title })}
          </p>

          <StepBlock title={t("uniApp.step1Title")}>
            <p>{t("uniApp.step1Desc")}</p>
            {draft.essay && (
              <p>{tReplace("uniApp.step1Essay", locale, { name: title })}</p>
            )}
          </StepBlock>

          <StepBlock title={t("uniApp.step2Title")}>
            <p>{t("uniApp.step2Desc1")}</p>
            <p>{t("uniApp.step2Desc2")}</p>
          </StepBlock>
          ...
          <div className="flex items-start gap-3 rounded-xl border border-[#F4C430] bg-[#FFF9EC] p-4">
            ...
            <p className="text-[15px] leading-relaxed text-[#8a6d17]">
              {t("uniApp.signatureWarning")}
            </p>
          </div>

          <StepBlock title={t("uniApp.step3Title")}>
            <p>{t("uniApp.step3Desc")}</p>
          </StepBlock>
...
function ReviewSubmitModal({
  ...
  const stages: { key: ReviewStage; label: string }[] = [
    { key: "review", label: t("uniApp.stageReview") },
    { key: "payment", label: t("uniApp.stagePayment") },
    { key: "signature", label: t("uniApp.stageSignature") },
  ];
  ...
  async function handleSubmit() {
    ...
    if (!draft.programId) {
      setSubmitError(t("uniApp.programRequired"));
      return;
    }
    if (!draft.preferredRound) {
      setSubmitError(t("uniApp.roundRequired"));
      return;
    }
    ...
    if (result.error || !result.applicationId || !result.submittedAt) {
      setSubmitError(result.error ?? t("uniApp.submitFailed"));
      setSubmitting(false);
      return;
    }
...
function ApplicationPreview({ university, title, locale, draft, studentData }: {
  ...
  return (
    <div className="p-10">
      ...
      <div className="mb-6 flex items-start justify-between border-b-2 border-[#2E7CD6] pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#888]">{t("uniApp.previewLabel")}</p>
          </div>
        </div>
      ...
      {/* Profile */}
      <Section title={t("uniApp.previewProfile")}>
        <SubSection title={t("uniApp.previewPersonal")}>
          <Row label={t("uniApp.rowName")} value={fullName || "—"} />
          <Row label={t("uniApp.rowNameTh")} value={profile?.first_name_th && profile?.last_name_th ? `${profile.last_name_th}, ${profile.first_name_th}` : "—"} />
          <Row label={t("uniApp.rowBirthdate")} value={profile?.dob ?? "—"} />
          <Row label={t("uniApp.rowNationality")} value={profile?.nationality ?? "—"} />
          <Row label={t("uniApp.rowGender")} value={profile?.gender ?? "—"} />
          <Row label={t("uniApp.rowIdType")} value={profile?.id_type ?? "—"} />
          <Row label={t("uniApp.rowIdNumber")} value={profile?.id_number ?? "—"} />
        </SubSection>
        <SubSection title={t("uniApp.previewContact")}>
          <Row label="Email" value={email} />
          <Row label={t("uniApp.rowPhone")} value={profile?.phone ?? "—"} />
          <Row label="LINE ID" value={profile?.line_id ?? "—"} />
          <Row label={t("uniApp.rowAddress")} value={formatAddress(profile?.address)} multiline />
        </SubSection>
      </Section>

      {/* Family */}
      <Section title={t("uniApp.previewFamily")}>
        {family ? (
          <>
            <SubSection title={t("uniApp.previewFather")}>
              <Row label={t("uniApp.rowName")} value={joinName(family.father_prefix, family.father_first_name, family.father_last_name)} />
              <Row label={t("uniApp.rowOccupation")} value={family.father_occupation ?? "—"} />
              <Row label={t("uniApp.rowEducation")} value={family.father_education_level ?? "—"} />
              <Row label={t("uniApp.rowPhone")} value={family.father_phone ?? "—"} />
            </SubSection>
            <SubSection title={t("uniApp.previewMother")}>
              <Row label={t("uniApp.rowName")} value={joinName(family.mother_prefix, family.mother_first_name, family.mother_last_name)} />
              <Row label={t("uniApp.rowOccupation")} value={family.mother_occupation ?? "—"} />
              <Row label={t("uniApp.rowEducation")} value={family.mother_education_level ?? "—"} />
              <Row label={t("uniApp.rowPhone")} value={family.mother_phone ?? "—"} />
            </SubSection>
            <SubSection title={t("uniApp.previewHousehold")}>
              <Row label={t("uniApp.rowHouseholdIncome")} value={family.household_income ?? "—"} />
              <Row label={t("uniApp.rowSiblings")} value={family.number_of_siblings?.toString() ?? "—"} />
            </SubSection>
          </>
        ) : (
          <p className="text-sm text-[#888]">{t("uniApp.noFamilyData")}</p>
        )}
      </Section>

      {/* Education */}
      <Section title={t("uniApp.previewEducation")}>
        {education ? (
          <SubSection title={t("uniApp.previewSchool")}>
            <Row label={t("uniApp.rowSchoolName")} value={education.school_name ?? "—"} />
            <Row label={t("uniApp.rowProvince")} value={education.school_province ?? "—"} />
            <Row label={t("uniApp.rowCurriculum")} value={education.curriculum_type ?? "—"} />
            <Row label={t("uniApp.rowStudyPlan")} value={education.study_plan ?? "—"} />
            <Row label="GPA" value={education.gpa?.toString() ?? "—"} />
            <Row label={t("uniApp.rowGradYear")} value={education.graduation_year?.toString() ?? "—"} />
            <Row label={t("uniApp.rowGradeLevel")} value={education.current_grade_level ?? "—"} />
          </SubSection>
        ) : (
          <p className="text-sm text-[#888]">{t("uniApp.noEducationData")}</p>
        )}
      </Section>

      {/* Testing */}
      <Section title={t("uniApp.previewTesting")}>
        {scores.length > 0 ? (
          ...
          <p className="text-sm text-[#888]">{t("uniApp.noTestScores")}</p>
        )}
      </Section>

      {/* Documents */}
      <Section title={t("uniApp.previewDocuments")}>
        {documents.length > 0 ? (
          <ul className="space-y-1 text-sm text-[#1a1a1a]">
            {documents.map((d) => (
          ...
          <p className="text-sm text-[#888]">{t("uniApp.noDocumentsAttached")}</p>
        )}
      </Section>

      {/* Activities */}
      <Section title={t("uniApp.previewActivities")}>
        {portfolioItems.length > 0 ? (
          ...
          <p className="text-sm text-[#888]">{t("uniApp.noActivitiesToReport")}</p>
        )}
      </Section>

      {/* University-specific */}
      <Section title={tReplace("uniApp.uniQuestions", locale, { name: title })}>
        <SubSection title={t("uniApp.previewGeneral")}>
          <Row label={t("uniApp.rowPreferredRound")} value={draft.preferredRound ? `Round ${draft.preferredRound}` : "—"} />
          <Row label={t("uniApp.rowPreferredPlan")} value={draft.admissionPlan ?? "—"} />
        </SubSection>
        <SubSection title={t("uniApp.previewAcademics")}>
          <Row label={t("uniApp.rowFaculty")} value={selectedFaculty ? (locale === "th" && selectedFaculty.name_th ? selectedFaculty.name_th : selectedFaculty.name) : "—"} />
          <Row label={t("uniApp.rowProgram")} value={selectedProgram ? (locale === "th" && selectedProgram.name_th ? selectedProgram.name_th : selectedProgram.name) : "—"} />
        </SubSection>
        {draft.essay && (
          <SubSection title={t("uniApp.essayLabel")}>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-xl border border-[#e0e0e0] bg-white p-8 space-y-6">
        <div>
          <h2 className="text-xl font-bold text-[#1a1a1a]">{t("uniApp.signatureTitle")}</h2>
          <p className="mt-1 text-sm text-[#666]">{t("uniApp.signatureDesc")}</p>
          <input
            type="text"
            value={signatureName}
            onChange={(e) => setSignatureName(e.target.value)}
            placeholder={t("uniApp.signaturePlaceholder")}
        ...
        <div className="border-t border-[#e8e8e8] pt-6">
          <h2 className="text-xl font-bold text-[#1a1a1a]">{t("uniApp.affirmationsTitle")}</h2>
          <label className="mt-3 flex items-start gap-3 text-[15px] leading-relaxed text-[#444]">
            ...
            />
            <span>{t("uniApp.affirmationText")}</span>
          </label>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 rounded-xl border border-[#F4C430] bg-[#FFF9EC] p-4">
        <AlertTriangle size={20} className="mt-0.5 shrink-0 text-[#b88a12]" />
        <p className="text-[15px] leading-relaxed text-[#8a6d17]">{t("uniApp.finalWarning")}</p>
      </div>
    </div>
  );
}
